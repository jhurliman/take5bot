...
export class EngineBot {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        EngineBotFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    /**
     * @param {string} spec
     * @param {Uint8Array | null | undefined} weights
     * @param {bigint} seed
     */
    constructor(spec, weights, seed) {
        const ptr0 = passStringToWasm0(spec, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(weights) ? 0 : passArray8ToWasm0(weights, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        const ret = wasm.enginebot_new(ptr0, len0, ptr1, len1, seed);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        EngineBotFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) EngineBot.prototype[Symbol.dispose] = EngineBot.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./take5_wasm_bg.js": import0,
    };
}

const EngineBotFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('take5_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
